...
$agentsLines += ""
$agentsLines += "## Platform -- read before any tool call"
$agentsLines += "- R 4.5.2 NOT in PATH: ``C:\Users\rich\AppData\Local\Programs\R\R-4.5.2\bin\R.exe``"
$agentsLines += "- Python 3.13.9 NOT in PATH: ``C:\Users\rich\AppData\Local\miniconda3\python.exe`` (envs: base, pyopt)"
$agentsLines += "- ``python3`` is a Windows Store stub -- exit 49. Never use it."
$agentsLines += "- LaTeX, git, gh, Node.js v24 -- all in PATH"
...
$agentsLines += ""
$agentsLines += "## helpi command reference"
$agentsLines += "Run: ``helpi N $Project [-Force]``  (omit project where marked --)"
$agentsLines += ""
$agentsLines += "| N  | Command                        | Project? | When to use |"
$agentsLines += "|----|---------------------------------|----------|-------------|"
$agentsLines += "| 1  | Create new project              | Yes      | Once per paper |"
$agentsLines += "| 2  | Pull ALL projects from Overleaf | --       | Start of day |"
$agentsLines += "| 3  | Pull ONE project from Overleaf  | Yes      | Before opening a project |"
$agentsLines += "| 4  | Push local edits to Overleaf    | Yes      | After editing manuscript locally |"
$agentsLines += "| 5  | Compile + open VS Code + PDF    | Yes      | Start of working session |"
$agentsLines += "| 6  | Compile LaTeX + open PDF only   | Yes      | Quick recompile |"
$agentsLines += "| 7  | Log + handover + open browser   | Yes      | End of session / checkpoint |"
$agentsLines += "| 8  | Snapshot Overleaf (git tag)     | Yes      | Before major revision or submission |"
$agentsLines += "| 9  | Rollback last N code commits    | Yes      | Undo bad code changes (PERMANENT) |"
$agentsLines += "| 10 | Build submission package        | Yes      | Submitting a paper |"
$agentsLines += "| 11 | Reviewer scaffold (.txt->LaTeX) | Yes      | After receiving reviewer comments |"
$agentsLines += "| 12 | Reviewer draft loop             | Yes      | After annotating scaffold in Overleaf |"
$agentsLines += "| 13 | Project status dashboard        | --       | Anytime |"
$agentsLines += "| 14 | Open project network graph      | --       | Anytime |"
$agentsLines += "| 15 | Open infrastructure guide       | --       | Anytime |"
$agentsLines += "| 16 | Generate docs (HTML/PDF)        | --       | After editing infrastructure.html |"
$agentsLines += "| 17 | Claude Code cheatsheet          | --       | Anytime |"
$agentsLines += "| 18 | Toggle Claude model-check       | --       | Anytime |"
$agentsLines += "| 19 | Generate Beamer slides          | Yes      | Before a presentation |"
$agentsLines += "| 20 | Restore on replacement machine  | --       | Machine setup |"
$agentsLines += "| 21 | First-time setup for new user   | --       | Machine setup |"
$agentsLines += "| 22 | Compress AI log                 | Yes      | Auto-run by /close; manual on demand |"
$agentsLines += "| 23 | Push code/ to GitHub            | Yes      | After code changes |"
$agentsLines += "| 24 | Technical one-pager from paper  | Yes      | Anytime |"
$agentsLines += ""
$agentsLines += "## How to add a session entry"
$agentsLines += "Append a new block to ``_ai_log.md`` in this project root, then run ``helpi 7 $Project`` to regenerate this file."
$agentsLines += '```'
